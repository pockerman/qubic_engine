#include "cubic_engine/rl/algorithms/td/q_learning.h"
...
using cengine::rl::algos::td::QLearning;
...
int main(){
    ...
    try{
        ...
        QLearning<gymfcpp::TimeStep, EpsilonGreedyPolicy> qlearn(5000, 1.0e-8,
