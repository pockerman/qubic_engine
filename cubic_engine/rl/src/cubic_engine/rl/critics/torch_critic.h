#ifndef TORCH_CRITIC_H
#define TORCH_CRITIC_H
...
///
/// \brief The TorchCriticImpl class
///
class TorchCriticImpl: public torch::nn::Module
{
...
public:
    ...
    ///
    TorchCriticImpl(actions::ActionSpace action_space,
