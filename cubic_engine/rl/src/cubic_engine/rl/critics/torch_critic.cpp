...
#include "cubic_engine/rl/critics/torch_critic.h"
...
TorchCriticImpl::TorchCriticImpl(actions::ActionSpace action_space,
...
TorchCriticImpl::act(torch::Tensor inputs, torch::Tensor rnn_hxs, torch::Tensor masks) const{
...
std::vector<torch::Tensor>
TorchCriticImpl::evaluate_actions(torch::Tensor inputs,
...
torch::Tensor
TorchCriticImpl::get_probs(torch::Tensor inputs,
                        torch::Tensor rnn_hxs,
...
torch::Tensor
TorchCriticImpl::get_values(torch::Tensor inputs,
                         torch::Tensor rnn_hxs,
                            torch::Tensor masks) const{
...
void
TorchCriticImpl::update_observation_normalizer(torch::Tensor observations){
