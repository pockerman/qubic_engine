#ifndef RIDGE_FUNCTION_H
#define RIDGE_FUNCTION_H
...
class RidgeFunction: public kernel::FunctionBase<real_t, InputTp...>
{
...
public:
    ...
    /// \brief Constructor
    RidgeFunction(const FunctionTp& function, real_t lambda,
...
template<typename FunctionTp, typename...InputTp>
RidgeFunction<FunctionTp, InputTp...>::RidgeFunction(const FunctionTp& function, real_t lambda,
                                                     uint_t coeff_start, uint_t coeff_end)
    :
...
template<typename FunctionTp, typename... InputTp>
typename RidgeFunction<FunctionTp, InputTp...>::output_t
RidgeFunction<FunctionTp, InputTp...>::value(const InputTp&...  /*input*/)const{
...
template<typename FunctionTp, typename...InputTp>
DynVec<real_t>
RidgeFunction<FunctionTp, InputTp...>::gradients(const InputTp&...)const{

#ifdef USE_LOG
    kernel::Logger::log_warning("RidgeFunction<FunctionTp>::gradients should not be called");
#endif
